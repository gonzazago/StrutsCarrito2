				...
				<tbody>
			     <c:forEach items="${servicioproducto}" var="producto">
					<tr>
						...
						<td>
						<a href="/ropa/altaStockCantidad?id=${producto.id}" class="pull-left color2">Agregar Stock</a>	
					    <!--<a href="/ropa/bajaProConfirma?id=${producto.id}" class="pull-right color2">Revertir</a>  -->																						
						</td>
					</tr>
				 </c:forEach>
				</tbody>
