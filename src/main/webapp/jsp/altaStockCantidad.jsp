		 ...
		 <div id="contact-page" class="container table-responsive">
				...
				<tbody>
	    			...
	    			<div class="contact-form">
				    	<form:form action="/ropa/altaStockCantidadOk" modelAttribute="producto, cantidad" role="form"  method="POST" name="altaStock">
				            <div class="form-group col-xs-8 col-md-8 col-sm-8">
				            	<input type="hidden" name="id" value="${producto.id}"/>
				            	<input type="hidden" name="cantidadanterior" value="${cantidad}"/>
				                <input type="number" min="1" max="9999" name="cantidad" class="form-control" placeholder="Nueva Cantidad" required="required"/>
				            </div>	
				            <div class="form-group col-xs-4 col-md-4 col-sm-4">
				                <input type="submit" name="stockagre" class="btn btn-primary" value="Agregar"/>
				            </div>																										
				        </form:form>
	    			</div>																					
						</td>
