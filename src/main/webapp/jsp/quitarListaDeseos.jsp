    	...
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12 padding-right">      			   			
					<h1 class="title text-center">¿Realmente quieres quitar este producto de tu lista de deseos?</h1>    			    				    				
				</div>			 		
			</div> 
		
		 <div id="contact-page" class="container table-responsive">
		<form:form action="" modelAttribute="producto" id="main-contact-form" class="contact-form row"  method="GET" name="bajaLista">
			...
			<br/>
			<a href="/ropa/verMiListaDeseos"><input type="button" name="volver" class="btn btn-primary pull-left" value="Cancelar"/></a>
			<a href="/ropa/quitarListaDeseosConfirmado?id=${producto.id}"><input type="button" name="volver" class="btn btn-primary pull-right" value="Quitar"/></a>
			<br></br>
	  	 </div> 
