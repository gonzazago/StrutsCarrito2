			...
			<table class="table table-bordered sortable-theme-bootstrap" data-sortable>
				...
				<c:forEach items="${servicioproducto}" var="producto">
					...
					<input type="hidden" name="id" value="${producto.id}"/>
						<td ><a href="/ropa/productoBuscado?id=${producto.id}"><img src="images/productos/${producto.nombreimagen}" width="50px" height="50px" alt=""/><i class="fa fa-search-plus color2"/></a></td>
